...
download.file(url="http://curl.haxx.se/ca/cacert.pem",
              destfile="/Users/sabreenaabedin/Desktop/test.txt",
              method="curl")
...
tweet_words <- tweet_DF %>% unnest_tokens(word, text)

tweet_bigrams <- tweet_DF %>% unnest_tokens(bigram, text, token = "ngrams", n=2)
